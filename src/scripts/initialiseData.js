...
export function initialise() {
    ...
    //Tank actions
    const BReprisal = new Buff(0,0,10,10,0,10,60,1,true,false,"Reprisal","https://xivapi.com/i/013000/013901.png",false,"Mitig");
    const BRampart = new Buff(0,0,20,20,0,20,90,1,false,false,"Rampart","https://xivapi.com/i/010000/010152.png",false,"Mitig");
    ...
    let Bulwark = new Skill("Bulwark","https://assets.rpglogs.com/img/ff/abilities/000000-000167.png");
    Bulwark.addBuff(BBulwark);
    ...
    const BStem_the_Flow = new Buff(0,0,10,10,0,4,25,1,false,false,"Stem the Flow","https://assets.rpglogs.com/img/ff/abilities/012000-012563.png",false,"Mitig");
    const BStem_the_Tide = new Buff(400,0,0,0,0,20,25,1,false,false,"Stem the Tide","https://assets.rpglogs.com/img/ff/abilities/012000-012564.png",false,"Mitig");
    ...
    const BThe_Blackest_Night = new Buff(0,25,0,0,0,7,15,1,false,true,"The Blackest Night","https://xivapi.com/i/013000/013118.png",false,"Mitig");
    const BOblation = new Buff(0,0,10,10,0,10,60,2,false,true,"Oblation","https://xivapi.com/i/013000/013123.png",false,"Mitig");
    ...
    const BHeart_of_Corundum = new Buff(0,0,15,15,0,8,25,1,false,true,"Heart of Corundum","https://xivapi.com/i/013000/013615_hr1.png",false,"Mitig");
    const BClarity_of_Corundum = new Buff(0,0,15,15,0,4,25,1,false,true,"Clarity of Corundum","https://xivapi.com/i/013000/013617_hr1.png",false,"Mitig");
    const BCamouflage = new Buff(0,0,10,10,50,20,90,1,false,false,"Camouflage","https://xivapi.com/i/013000/013602.png",false,"Mitig");
    ...
    const BAspect_Benefic = new Buff(625,0,0,0,0,30,0,1,false,true,"Aspect Benefic","https://xivapi.com/i/013000/013253.png",false,"Mitig");
    const BAspect_Helios = new Buff(312.5,0,0,0,0,30,0,1,true,false,"Aspect Helios","https://xivapi.com/i/013000/013253.png",false,"Mitig");
    const BExaltation = new Buff(0,0,10,10,0,8,60,1,false,true,"Exaltation","https://xivapi.com/i/013000/013262.png",false,"Mitig");
    ...
    const BSeraphic_Veil = new Buff(180,0,0,0,0,30,0,1,false,true,"Seraphic Veil","https://assets.rpglogs.com/img/ff/abilities/012000-012848.png",false,"Mitig");
    const BFey_Illumination = new Buff(0,0,0,5,0,20,120,1,true,false,"Fey Illumination","https://assets.rpglogs.com/img/ff/abilities/012000-012828.png",false,"Mitig");
    const BSacred_Soil = new Buff(0,0,10,10,0,15,30,1,true,false,"Sacred Soil","https://assets.rpglogs.com/img/ff/abilities/012000-012803.png",false,"Mitig");
 //   const BCatalyze = new Buff(540,0,0,0,0,30,0,1,false,true,"Catalyze","https://assets.rpglogs.com/img/ff/abilities/012000-012814.png",false,"Mitig");
    ...
    const BHolos_mitig = new Buff(0,0,10,10,0,20,120,1,true,false,"Holos (mitig)","https://assets.rpglogs.com/img/ff/abilities/012000-012971.png",false,"Mitig");
    const BPanhaimatinon = new Buff(200,0,0,0,0,15,120,1,true,false,"Panhaimatinon","https://xivapi.com/i/017000/017355.png",false,"Mitig");
    const BHaimatinon = new Buff(300,0,0,0,0,15,120,1,false,true,"Haimatinon","https://xivapi.com/i/017000/017585.png",false,"Mitig");
    const BEukrasian_Diagnosis = new Buff(540,0,0,0,0,30,0,1,false,true,"Eukrasian Diagnosis","https://xivapi.com/i/012000/012954.png",false,"Mitig");
    const BPneuma = new Buff(600,0,0,0,0,0,120,1,true,false,"Pneuma","https://xivapi.com/i/003000/003686.png",false,"Heal");
 //   const BDifferential_Diagnosis = new Buff(540,0,0,0,0,30,0,1,false,true,"Differential Diagnosis","https://xivapi.com/i/012000/012955.png",false,"Mitig");
    const BTaurochole = new Buff(0,0,10,10,0,15,42,1,false,true,"Taurochole","https://xivapi.com/i/012000/012965.png",false,"Mitig");
    ...
    let Pneuma = new Skill("Pneuma","https://xivapi.com/i/003000/003686.png");
    Pneuma.addBuff(BPneuma);
    ...
    //Melee actions
    const BFeint = new Buff(0,0,10,5,0,10,90,1,true,false,"Feint","https://xivapi.com/i/013000/013904.png",false,"Mitig");
    ...
    const BDismantled  = new Buff(0,0,10,10,0,10,120,1,true,false,"Dismantled","https://assets.rpglogs.com/img/ff/abilities/013000-013009.png",false,"Mitig");
    ...
    const BAddle = new Buff(0,0,5,10,0,10,90,1,true,false,"Addle","https://xivapi.com/i/013000/013917.png",false,"Mitig");
